...
const CoordinatorNavbar = () => {
    ...
    const navLinks = [
        ...
        { label: "Host Event", path: "/coordinator/host-event" },
        { label: "My Events", path: "/coordinator/my-events" },
        { label: "Analytics", path: "/coordinator/analytics" },
        { label: "Profile", path: "/coordinator/profile" }
    ];
    ...
    return (
        <header style={headerStyle}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', maxWidth: '1200px', margin: '0 auto' }}>
                ...
                {/* Logo */}
                <Link to="/coordinator/dashboard" style={{ display: 'flex', alignItems: 'center', gap: '10px', textDecoration: 'none' }}>
                    ...
                    {navLinks.map((link) => {
                        ...
                        return (
                            ...
                            >
                                {link.label}
                                {isActive && (
                                    <div style={{ position: 'absolute', bottom: '-4px', left: 0, width: '100%', height: '2px', background: 'var(--cyan)', borderRadius: '2px' }} />
                                )}
                            </NavLink>
                        );
                    })}
                        ...
                        <div style={{ position: 'relative' }} ref={dropdownRef}>
                            <div
                                style={{
                                    ...
                                    border: dropdownOpen ? '2px solid var(--cyan)' : '2px solid transparent',
                                    transition: 'all 0.2s'
                                }}
                                ...
                                <div className="glass" style={{
                                    ...
                                    <div style={{ padding: '10px', display: 'flex', flexDirection: 'column', gap: '4px' }}>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                            ...
                                            <span style={{ fontSize: '10px', padding: '2px 8px', background: 'var(--cyan)', borderRadius: '10px', color: '#0F172A', fontWeight: 'bold' }}>Coordinator</span>
                                        </div>
                                        <span style={{ fontSize: '12px', color: 'var(--cyan)', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{user.collegeName}</span>
                                    ...
                                    <Link to="/coordinator/profile" className="dropdown-item" style={{ padding: '8px 10px', textDecoration: 'none', color: '#E2E8F0', borderRadius: '8px' }}>
                                        My Profile
                                    </Link>
                                    <Link to="/coordinator/my-events" className="dropdown-item" style={{ padding: '8px 10px', textDecoration: 'none', color: '#E2E8F0', borderRadius: '8px' }}>
                                        My Events
                                    </Link>
                                    <Link to="/coordinator/analytics" className="dropdown-item" style={{ padding: '8px 10px', textDecoration: 'none', color: '#E2E8F0', borderRadius: '8px' }}>
                                        Analytics
                                    </Link>
